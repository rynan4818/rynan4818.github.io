...
## [CameraSongScript](https://github.com/rynan4818/CameraSongScript)
...
<img width="540" height="420" alt="image" src="https://github.com/user-attachments/assets/94818e60-9fae-45cd-a5d8-e46fbbe44bd5" />

## [CameraScriptManager](https://github.com/rynan4818/CameraScriptManager)

Beat Saber のカメラスクリプト (`SongScript.json` / CameraPlus MovementScript 形式 JSON) を整理、配布、配置するための Windows 用デスクトップツールです。

## [BS-CameraMovement](https://github.com/rynan4818/BS-CameraMovement)

Beat Saberの公式譜面エディタ にカメラワーク機能を追加、[ChroMapper-CameraMovement](https://github.com/rynan4818/ChroMapper-CameraMovement)のOSCを受信してエディタとプレイ画面で同期する Mod です。

<img width="641" height="416" alt="image" src="https://github.com/user-attachments/assets/4fcc3f68-17ac-4166-89d5-33692747612f" />
<img width="641" height="376" alt="image" src="https://github.com/user-attachments/assets/fe98fb10-2e50-463d-8c17-b33c9915975f" />
...
## [ChroMapper-PrecisionStepAdditions](https://github.com/rynan4818/ChroMapper-PrecisionStepAdditions)
ChroMapperのカーソル移動単位の枠を3～5個の範囲で拡張することができるプラグインです。

<img src="https://github.com/user-attachments/assets/5c7e4275-7f15-4a3c-b8d1-cd7be479ec4e" width="527" hight="119">
...
# バーチャルモーションキャプチャー関係
## [VMCBlendShapeControl](https://github.com/rynan4818/VMCBlendShapeControl)

Beat Saber から [VirtualMotionCapture](https://vmc.info/) へ、曲時間およびゲームイベントに連動した BlendShape 制御を [VMC Protocol](https://protocol.vmc.info/Reference)を使って OSC 送信するBeat Saber mod

## [VMCFaceShortcutTransitionMod](https://github.com/rynan4818/VMCFaceShortcutTransitionMod)

VirtualMotionCapture (VMC) の表情ショートカット操作に、補間付きの遷移時間を追加するVMC用 Mod
...
## [ModsTabSorter](https://github.com/rynan4818/ModsTabSorter)

譜面選択メニュー画面左側にある `MODS` タブ内の表示順を、任意の並びに変更し保存できる Beat Saber mod

<img width="426" height="328" alt="image" src="https://github.com/user-attachments/assets/0a482bb4-6283-449c-8062-792e791291fd" />

## [JBSLViewer](https://github.com/rynan4818/JBSLViewer)

[JBSL-Web](https://jbsl-web.herokuapp.com/)の情報を表示するBeatSaber mod

<img width="316" height="295" alt="image" src="https://github.com/user-attachments/assets/03c01179-40c5-45e3-a5e4-eee59ba9d157" />

## [ViewerCountDisplay](https://github.com/rynan4818/ViewerCountDisplay)
[EnhancedStreamChat v3](https://github.com/denpadokei/EnhancedStreamChat-v3)のチャット画面の右下に視聴者数と配信時間を表示するBeatSaber mod

<img width="345" height="280" alt="image" src="https://github.com/user-attachments/assets/deddd274-3ad3-4d96-8589-f9ba59e6701f" />
...
## [BeatSaberプレイヤーバージョン分布](https://rynan4818.github.io/BeatSaberVer.html)
らっきょさんの[player_count_by_bs_version](https://github.com/rakkyo150/player_count_by_bs_version)の履歴データを使ってプレイヤーバージョン分布のグラフ表示するサイト
